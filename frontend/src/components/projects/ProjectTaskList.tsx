        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:flex-wrap sm:items-center">
          ...
          <div className="relative w-full sm:w-56">
            <input
              ...
              className="w-full rounded-lg border border-border bg-background py-2 pr-10 pl-4 text-sm text-ink placeholder:text-text-placeholder focus:border-primary focus:ring-1 focus:ring-primary focus:outline-none"
            />
            <svg
